...
export const searchEmergencies = backend.searchEmergencies;
...
export const approveCase = backend.approveCase;
export const rejectCase = backend.rejectCase;
export const createPatient = backend.createPatient;
export const getPatient = backend.getPatient;
